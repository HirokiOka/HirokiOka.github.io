  ...
  return (
    ...
    Webフロントエンドエンジニア．大学時代は電気電子工学を専攻し，プログラミング初学者の学習支援システムに関する研究や，クリエイティブコーディングを行っていた．ReactやTypeScriptなどの技術を軸に，驚きや没入感を生むようなWeb表現を探る．博士 (工学)．
          ...
          <ol className='list-decimal list-inside text-base mx-8'>
            ...
            <li><span className='underline'>H. Oka</span>, A. Ohnishi, T. Terada, M. Tsukamoto: <Link href="http://www.infsoc.org/conference/iwin2024/download/IWIN2024-Proceedings.pdf" className={linkClass}> Competitive Programming Game to Promote Programming Motivation for Non-Programmers by Highlighting Programmer Coolness</Link>, <span className='italic'>Proc. of 18th International Workshop on Informatics (IWIN2024)</span>, pp. 225--231 (Sep. 2024).</li>
          </ol>
